/** @file gsSpaceTimeLocalisedAssembler.h

    @brief Provides localised assembler for a homogeneous heat equation.
...
*/
        ...
        void assemble()
        {
            ...
            Base::template push<gsVisitorLocalisedSpaceTime<T> >();

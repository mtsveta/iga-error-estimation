 ...
 */
    ...
    public:
        ...
        /** \brief Constructor for gsVisitorSpaceTimeTestsForErrorControl.
         *
                             ...
                             gsVector<T> const      & quWeights)
        {
            ...
            */
            ...
            for (index_t k = 0; k < quWeights.rows(); ++k) // loop over quadrature nodes
            {
                ...
                //h = element.getMaxCellLength();
                //h = element.getMinCellLength();
                T theta = thetaVals(0, k);
                //theta = h;
                //theta = std::pow(element.getMinCellLength(), 1);
                //theta = std::pow(element.getMinCellLength(), 2);
                //theta = 0.0;
                T delta_h = theta * h;

/** @file gsSpaceTimeDeltaxNorm.h

    @brief Computes the || Delta_x u || norm.
...
*/
    template <class T>
    class gsSpaceTimeDeltaxNorm : public gsNorm<T>
    {
    ...
    public:
        ...
        gsSpaceTimeDeltaxNorm(const gsField<T> & _field1,
    ...
    protected:
                         ...
                         T & accumulated)
        {
            ...
            for (index_t k = 0; k < quWeights.rows(); ++k) // loop over quadrature nodes
            {
                ...
                sum += weight * ( (func1SpaceLaplace - func2SpaceLaplace).squaredNorm() );
